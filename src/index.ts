import { recettes as recipes } from "./js/recipes.js"
import  { galleryCard }  from "./js/galleryCard.js"
import { handleFilters } from "./js/filterInit.js"
import { buildAllArrays } from "./js/buildAllArrays.js"
import { typedFilters as filters } from './js/filterInit.js'
import filterRecipes from "./js/filterArrays.js"
import preciseFilter from "./js/preciseFilter.js"
import filterTagsCreator from "./js/filterTags.js"
    ...
    for (const filterType in currentProperties) {
        ...
        for (const filter in currentProperties[type]) {
            ...
            filterDiv.addEventListener("click", (e) => {
                ...
                const value = event.innerText.toLowerCase()
...
function mainFilterFunction(currentFilter) {
    ...
    const matchingRecipes =  filterRecipes(currentFilter)
...
const preciseInputs: any = document.querySelectorAll(".dropdown_input")
...
preciseInputs.forEach(input => {
    input.addEventListener("focus", (e) => {
        const itemList = e.composedPath[2].children[1]
